function Converter(){
    ...
    var valor = valorElemento.value; //O .value pega somente o valor que foi colocado dentro do box, se tirar o .value pegaria toda a linha de codigo do html
    var valorEmDolarNumerico = parseFloat(valor);  //comando parseFloat transforma a string da caixa em um numero com casas decimais.
